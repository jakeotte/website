...
I will keep this overview high-level - the NTLM relay attack has been explained in great technical depth by many other blogs (see [here](https://www.vaadata.com/blog/understanding-ntlm-authentication-and-ntlm-relay-attacks/)).
...
> ![adcs_auth](assets/img/ntlm/ldap_gpo.png)
